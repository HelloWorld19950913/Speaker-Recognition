# -*- coding: utf-8 -*-
"""UBM_feature_extraction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1K3qUvJ0noRc_9HhCIQcqst5juhO4OF6k
"""
...
#Audio Files Path
FilesPath = "/home/srinath/Desktop/Timit_data"
...
# audio, sample_rate_ref = ReadAudio( Files[0] )
# print(sample_rate_ref)



'''
****************
For Testing We keep the lenFiles value = 10 and 
save the features in folder Features2 instead of Features
****************
'''
#Changing the lenFiles Value
lenFiles = 10
...
# 	if sample_rate_ref != sample_rate :
# 		print(sample_rate)
# 		print(x)
	...
	print("Audio Reading Done of index: " + str(x))
...
for x in range(lenFiles):
    ...
    '''
    ************
    Folder Name is changed to Features2 instead of Features
    ************
    
    '''
    savenp( arr = feature, filename = "/home/srinath/Desktop/SpeakerRecognition/Features2/features" + str(x))
    print("Feature Extraction Done of index: " + str(x))
